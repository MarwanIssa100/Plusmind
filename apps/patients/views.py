...
#     @swagger_auto_schema(
#         operation_description="Retrieve authenticated patient profile",
#         responses={
#             200: openapi.Response("Authenticated patient's profile", PatientRegisterSerializer),
#             404: "Patient profile not found"
#         },
#         operation_summary="Get Authenticated Patient",
#         tags=["Patient"]
#     )
#     def me(self, request):
#         try:
